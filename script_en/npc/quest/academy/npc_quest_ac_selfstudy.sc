...
ac_cl_room.gat,152,41,4	script	ユタ#ac_cl_room	84,{
	...
	while(1){
		...
		mes "何でも教えるよ。";
		next;
		switch(select("Swordsman","Magician","Acolyte","Thief","Archer","Merchant","Taekwon Kid","特殊一次職","職業についてはわかった")){
		case 1:
			mes "[ユタ]";
			mes "Swordsmanだね。";
			mes "Swordsmanへの転職は、";
			mes "^0000FFIzludeの街の西の方^000000";
		...
		case 2:
			...
			mes "Magicianだね。";
			mes "Magicianへの転職は、";
			mes "^0000FFGeffenの街の北西の方にある^000000";
		...
		case 3:
			...
			mes "Acolyteだね。";
			mes "Acolyteへの転職は、";
			mes "Pronteraの^0000FF街の北東の方^000000";
		...
		case 5:
			...
			mes "Archerだね。";
			mes "Archerへの転職は、";
			mes "^0000FFPayonArcher Villageにある";
		...
		case 6:
			...
			mes "Merchantだね。";
			mes "Merchantへの転職は、";
			mes "^0000FFAlbertaにある商人組合^000000で";
			mes "で行えるよ。";
			break;
		case 7:
			mes "[ユタ]";
			mes "Taekwon Kidだね。";
			mes "Taekwon Kidへの転職は、";
			mes "^0000FFPayon^000000で行えるよ。";
			next;
			mes "[ユタ]";
			mes "^0000FFPayonの街の中央^000000に";
		...
		case 8:
			...
			mes "聞きたい職業は何かな？";
			next;
			switch(select("Gunslinger","Ninja","Supernovice","他の職業について聞く")){
			case 1:
				mes "[ユタ]";
				mes "Gunslingerだね。";
				mes "Gunslingerへの転職は、";
				mes "^0000FFEinbroch^000000で行えるよ。";
				next;
				mes "[ユタ]";
				mes "^0000FFEinbrochの";
				...
				next;
				mes "[ユタ]";
				mes "Payonの^FF0000ファンソプル^000000に";
				mes "会うように言われるから、";
				mes "ファソンプルに会いに行こう。";
				mes "ファンソプルは、";
				mes "^0000FFPayonの街の南の方^000000にいる。";
				...
				mes "[ユタ]";
				mes "次は、お店で買える材料を言うね。";
				mes "ミルクは、^0000FFPronteraの街の南西の方^000000で";
			...
			case 2:
				mes "[ユタ]";
				mes "Ninjaだね。";
				mes "Ninjaへの転職は、^0000FFAmatsu^000000で行えるよ。";
				mes "まず、Amatsuで";
				mes "^FF0000クウガ・カイ^000000という人に会うんだ。";
				next;
				mes "[ユタ]";
				mes "クウガ・カイは、";
				mes "Amatsuの街の中央あたりにある";
				...
				while(1){
					next;
					switch(select("Amatsuへの行き方","AmatsuからEinbrochへの行き方","鉄鉱石、プラコンの集め方","もういい")){
					case 1:
						mes "[ユタ]";
						mes "Amatsuへは、";
						mes "Albertaから行けるんだ。";
					...
					case 2:
						mes "[ユタ]";
						mes "AmatsuからEinbrochへの";
						mes "行き方を言うね。";
						mes "まず、^0000FFAmatsuから";
						mes "船でAlbertaへ行くんだ。^000000";
						mes "これは無料で行けるよ。";
						next;
						mes "[ユタ]";
						mes "そして、次に";
						mes "^0000FFAlbertaから船でIzludeへ行く。^000000";
						mes "500Zenyかかるからね。";
						mes "そして、次に";
						next;
						mes "[ユタ]";
						mes "^0000FFIzludeから飛行船でYunoへ";
						mes "行くんだ。そのままYunoの";
						mes "飛行場で飛行船を乗り換えれば";
						mes "Einbrochへ行けるよ。^000000";
						mes "1200Zenyかかるからね。";
						next;
						mes "[ユタ]";
						mes "合計で1700Zeny";
			...
			case 3:
				...
				mes "[ユタ]";
				mes "Supernoviceの転職は、";
				mes "^0000FFAldebaran^000000で行えるよ。";
				mes "^0000FFAldebaranの街の";
				...
				while(1){
					next;
					switch(select("Aldebaranへの行き方","べとべとする液体、古木の露の入手方法","もういい")){
					case 1:
						mes "[ユタ]";
						mes "Aldebaranへは、";
						mes "Izludeから1800Zenyで";
						mes "カプラ転送サービスで行けるよ。";
						mes "　";
						mes "他に聞きたいことはあるかい？";
						continue;
		...
		default:
			if(!'@snovice){
				...
				mes "^0000FFFay^000000が転職場所へ";
				mes "送ってくれるから、";
				mes "聞いてみるといいよ。";
				next;
				mes "[ユタ]";
				mes "^0000FFFay^000000のいる^0000FF講習室^000000は";
	...
	case Job_Swordman:
		...
		while(1){
			...
			case 1:
				...
				mes "取得条件を満たしたら、";
				mes "Prontera騎士団の中にいる";
				mes "^FF0000レオ=フォン=フリッシュ^000000という人";
				mes "に話しかけてね。";
				next;
				mes "[フィー]";
				mes "Prontera騎士団は、";
				mes "Pronteraの街の北西にあるわよ。";
	...
	case Job_Thief:
		...
		while(1){
			...
			case 1:
				...
				mes "[フィー]";
				mes "あと、ピラMidoダンジョンは、";
				mes "Morrocの街内を北西に行くと、";
				mes "^0000FFピラMido周辺マップ^000000に行けるわ。";
				mes "そのマップの北西にあるのよ。";
			...
			case 3:
				...
				mes "を持っていくと、";
				mes "今度は^0000FFPayonにいる^000000";
				mes "^FF0000ポケット販売商人^000000に会うことになるの。";
				next;
				mes "[フィー]";
				mes "ポケット販売商人は、";
				mes "Payonの街の南西の方にいるわ。";
	...
	while(1){
		...
		case 2:
			...
			case Job_Gunslinger://共通
				...
				mes "^FF0000Prontera地下水路B2F^000000がいいかな。";
				mes "タロウやスポアを倒すといいわ。";
				mes "他にもモンスターが沢山いるから";
				...
				mes "[ルティー]";
				mes "Prontera地下水路は、";
				mes "Pronteraの街の西のマップ";
				mes "Pronteraフィールド05の";
				mes "中央あたりにいる^FF0000地下水路管理兵^000000";
				mes "に話しかければ行けるよ。";
				mes "座標だと、(^0000FF271,211^000000)あたりだね。";
				next;
				mes "[ルティー]";
				mes "ただし、Prontera地下水路に";
				mes "入るには、Prontera騎士団の";
				mes "許可が必要らしいわ。";
				mes "詳しくは、";
				mes "地下水路管理兵に聞いてみてね。";
				break;
			case Job_Magician:
				...
				mes "[ルティー]";
				mes "Baseレベルが^FF000025^000000くらいまでは、";
				mes "^FF0000Pronteraフィールド02^000000で";
				mes "マンドラゴラを倒すといいよ。";
				mes "Pronteraの街から東へ1マップ、";
			...
			case Job_Archer:
				...
				mes "おすすめの場所はね、";
				mes "Baseレベルが^FF000025^000000くらいまでは、";
				mes "^FF0000Payon地下洞窟B1階^000000がいいかな。";
				mes "ゾンビを倒すといいわよ。";
				mes "ゾンビには、銀矢を";
				mes "使用した方がいいね。";
				next;
			...
			case Job_Acolyte:
				...
				mes "おすすめの場所はね、";
				mes "Baseレベルが^FF000025^000000くらいまでは、";
				mes "^FF0000Payon地下洞窟1階^000000がいいかな。";
				mes "ゾンビを倒すといいよ。";
				next;
				mes "[ルティー]";
				mes "ゾンビ等の不死属性モンスターに";
				...
				mes "Payon地下洞窟は、";
				mes "Payonの街の北にある";
				mes "Archer Villageの北西あたりから行けるわ。";
		...
		case 3:
			...
			case Job_Swordman:
				...
				mes "^FF0000Payon迷いの森02^000000がいいかな。";
				mes "ウルフを倒すといいよ。";
				mes "Albertaの街から西へ2マップ";
				mes "移動すれば行けるよ。";
				next;
				mes "[ルティー]";
				mes "あと、";
				mes "^FF0000Payon迷いの森07^000000もいいね。";
				mes "そこで、エルダーウィローを中心に";
				mes "モンスターを倒すといいよ。";
				mes "Albertaの街から西へ1マップ";
				mes "北へ1マップ移動すれば行けるよ。";
				break;
			case Job_Magician:
				mes "[ルティー]";
			...
			case Job_Archer:
				...
				mes "おすすめの場所はね、";
				mes "Baseレベルが^FF000025～45^000000くらいまでは、";
				mes "^FF0000Payon迷いの森07^000000がいいかな。";
				mes "ウルフを倒すといいよ。";
				mes "Albertaの街から西へ2マップ";
				mes "移動すれば行けるんだ。";
				next;
			...
			case Job_Acolyte:
				...
				mes "おすすめの場所はね、";
				mes "Baseレベルが^FF000025～45^000000くらいまでは、";
				mes "^FF0000Payon地下洞窟B2F^000000がいいかな。";
				mes "Archerスケルトン、";
		...
		case 4:
			...
			case Job_Magician:
				...
				mes "Albertaの街を南へ2マップ";
				mes "移動すれば行けるよ。";
				next;
				mes "[ルティー]";
				mes "あと、";
				mes "^FF0000Louyangフィールド01^000000もいいわね。";
				mes "そこで、土精を倒すといいよ。";
				mes "Louyangの街を";
				mes "南に1マップ移動すれば行けるよ。";
				next;
			...
			case Job_Archer:
				mes "[ルティー]";
				mes "Baseレベルが^FF000045～55^000000くらいまでは、";
				mes "^FF0000Einbrochフィールド04^000000";
				mes "がいいかな。";
				mes "ジオグラファーを倒すといいね。";
				mes "ジオグラファーには、炎の矢を";
				mes "使用した方がいいよ。";
			...
			case Job_Acolyte:
				mes "[ルティー]";
				mes "Baseレベルが^FF000045～55^000000くらいまでは、";
				mes "^FF0000Amatsuダンジョン1F^000000が";
				mes "いいかな。";
				mes "銃奇兵を倒すといいよ。";
				...
				mes "[ルティー]";
				mes "ダンジョンを含め、";
				mes "Amatsu付近には強力なモンスターが";
				mes "沢山いるから、気をつけてね。";
				mes "特に、Amatsuダンジョンにいる";
				mes "カブキNinjaは要注意よ。";
				break;
			case Job_Merchant:
				mes "[ルティー]";
				...
				mes "メタリンを倒すといいね。";
				mes "メタリンは、";
				mes "^FF0000Lighthalzenフィールド01、^000000";
				mes "^FF0000Einbroch08^000000";
				mes "にいるよ。";
				next;
				mes "[ルティー]";
				mes "Lighthalzenフィールド01には";
				mes "Lighthalzenの街を";
				mes "北に1マップ移動すれば行けるよ。";
				mes "Einbroch08には";
				mes "Einbrochの街を";
			...
			case Job_Thief:
				...
				mes "メタリンを倒すといいね。";
				mes "メタリンは、";
				mes "^FF0000Lighthalzenフィールド01、";
				mes "Einbroch08^000000";
				mes "にいるよ。";
				next;
				mes "[ルティー]";
				mes "Lighthalzenフィールド01には";
