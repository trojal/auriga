...
L_QUEST01:
	...
	case 1:
		...
		mes "僕には幼馴染の女の子がいるんだ。";
		mes "彼女の名前はスザンヌ。";
		mes "^FF0000彼女はIzludeに住んでいる。^000000";
...
L_QUEST04:
	...
	case 1:
		...
		mes "ゴホッ、ゴホッ……";
		mes "ありがとう。";
		mes "僕の主治医は、^FF0000Geffen^000000にいるんだ。";
		mes "頼んだよ。";
		next;
		mes "^FF0000【ミッション】^000000";
		mes "‐Geffenにいる医者に話しかける‐";
		close2;
		set AC_QUEST_ST_0,2;
		end;
	case 2:
...
L_QUEST06:
	...
	case 1:
		...
		mes "[ハルバード]";
		mes strcharinfo(0) + "、";
		mes "お願いだから、^FF0000Comodo^000000に行って";
		mes "様子を見てきてくれないかい？";
		mes "何から何まで頼んで";
		mes "申し訳ないけど、お願いだよ。";
		next;
	...
	case 2:
		mes "[ハルバード]";
		mes "^FF0000Comodo^000000に行って、スザンヌの";
		mes "様子を見てきてくれないかい？";
		mes "何から何まで頼んで";
		mes "申し訳ないけど、お願いだよ。";
		next;
...
payon_in01.gat,6,55,4		script	指輪職人#AC_QUE00	901,{
	if(AC_QUEST_LV_0==4){
		...
		case 2:
			mes "[ジェラルド]";
			mes "場所は、^FF0000Morrocの";
			mes "ピラMido周辺の宝石商^000000のところじゃ。";
			mes "そこに、この指輪の依頼主が";
			mes "来ているはずじゃ。";
			mes "依頼主の名前は、^FF0000スザンヌ^000000じゃ。";
			mes "よろしく頼むぞ。";
...
L_QUEST09:
	...
	case 1:
		...
		menu "もちろんさ！",-;
		mes "[スザンヌ]";
		mes "まず、Rachelに探しに行こう！";
		next;
		mes "[スザンヌ]";
		mes "Rachelの中央の道を北に行くと";
		mes "フレイヤ神殿への階段があるの。";
		mes "その前で、落ち合いましょう！";
		next;
		mes "^FF0000【ミッション】^000000";
