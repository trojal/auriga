...
// 守備担当
//------------------------------------------------------------
arug_cas05.gat,146,315,3	script	Eeos#F5	868,{
	if('guardian1_x[0] == 0) {
...
OnSet:
OnTimer300000:
	hideoffnpc "1st Guardian Stone#F5";
	misceffect 247,"1st Guardian Stone#F5";
	set 'status,2;
	stopnpctimer;
	end;
OnAgitEnd:
...
arug_cas05.gat,65,171,0	script	1st Guardian Stone#F5	844,{
...
OnSet:
OnTimer300000:
	hideoffnpc "Second Guardian Stone#F5";
	misceffect 247,"Second Guardian Stone#F5";
	set 'status,2;
	stopnpctimer;
	end;
OnAgitEnd:
...
arug_cas05.gat,212,149,0	script	Second Guardian Stone#F5	844,{
...
arug_cas05.gat,136,158,0	script	Control Unit01#F5	111,{
...
OnAgitStart:
	...
	callguardian "arug_cas05.gat",140,157," ",1905,1,"Control Unit01#F5::OnKilled";
	callguardian "arug_cas05.gat",142,157," ",1905,1,"Control Unit01#F5::OnKilled";
	callguardian "arug_cas05.gat",144,157," ",1905,1,"Control Unit01#F5::OnKilled";
	callguardian "arug_cas05.gat",139,156," ",1905,1,"Control Unit01#F5::OnKilled";
	callguardian "arug_cas05.gat",141,156," ",1905,1,"Control Unit01#F5::OnKilled";
	callguardian "arug_cas05.gat",143,156," ",1905,1,"Control Unit01#F5::OnKilled";
	set 'count,6;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas05.gat","Control Unit01#F5::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas05.gat",139,158,144,158,0;
...
arug_cas05.gat,135,212,0	script	Control Unit02#F5	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "arug_cas05.gat",140,209," ",1905,1,"Control Unit02#F5::OnKilled";
	callguardian "arug_cas05.gat",142,209," ",1905,1,"Control Unit02#F5::OnKilled";
	callguardian "arug_cas05.gat",144,209," ",1905,1,"Control Unit02#F5::OnKilled";
	callguardian "arug_cas05.gat",139,208," ",1905,1,"Control Unit02#F5::OnKilled";
	callguardian "arug_cas05.gat",141,208," ",1905,1,"Control Unit02#F5::OnKilled";
	callguardian "arug_cas05.gat",143,208," ",1905,1,"Control Unit02#F5::OnKilled";
	set 'count,6;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas05.gat","Control Unit02#F5::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas05.gat",138,210,145,210,0;
...
arug_cas05.gat,134,266,0	script	Control Unit03#F5	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "arug_cas05.gat",139,262," ",1905,1,"Control Unit03#F5::OnKilled";
	callguardian "arug_cas05.gat",141,262," ",1905,1,"Control Unit03#F5::OnKilled";
	callguardian "arug_cas05.gat",143,262," ",1905,1,"Control Unit03#F5::OnKilled";
	callguardian "arug_cas05.gat",145,262," ",1905,1,"Control Unit03#F5::OnKilled";
	set 'count,4;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas05.gat","Control Unit03#F5::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas05.gat",138,263,145,263,0;
...
arug_cas05.gat,45,158,0		duplicate(#LinkFlag_F5)	Banadis#A01	111
arug_cas05.gat,226,156,0	duplicate(#LinkFlag_F5)	Banadis#A02	111
arug_cas05.gat,134,62,0		duplicate(#LinkFlag_F5)	Banadis#A03	111
arug_cas05.gat,149,62,0		duplicate(#LinkFlag_F5)	Banadis#A04	111
arug_cas05.gat,123,154,0	duplicate(#LinkFlag_F5)	Banadis#A05	111
arug_cas05.gat,160,154,0	duplicate(#LinkFlag_F5)	Banadis#A06	111
arug_cas05.gat,135,205,0	duplicate(#LinkFlag_F5)	Banadis#A07	111
arug_cas05.gat,148,205,0	duplicate(#LinkFlag_F5)	Banadis#A08	111
arug_cas05.gat,134,260,0	duplicate(#LinkFlag_F5)	Banadis#A09	111
arug_cas05.gat,149,260,0	duplicate(#LinkFlag_F5)	Banadis#A10	111
arug_cas05.gat,148,103,4	duplicate(#LinkFlag_F5)	Banadis#B11	722
arug_cas05.gat,135,103,4	duplicate(#LinkFlag_F5)	Banadis#B12	722
arug_cas05.gat,63,51,7		duplicate(#LinkFlag_F5)	Banadis#B13	722
arug_cas05.gat,214,51,1		duplicate(#LinkFlag_F5)	Banadis#B14	722

//============================================================
// Kafra Staff
//------------------------------------------------------------
arug_cas05.gat,315,98,5	script	Kafra Staff::AgitKafra_F5	117,{
...
// 執事
//------------------------------------------------------------
arug_cas05.gat,328,98,3	script	Butler	55,{
...
aru_gld.gat,289,103,6	duplicate(#GldFlag_F5a)	Banadis#a01	722
aru_gld.gat,289,112,6	duplicate(#GldFlag_F5a)	Banadis#a02	722
aru_gld.gat,350,98,6	duplicate(#GldFlag_F5a)	Banadis#a03	722
aru_gld.gat,350,88,6	duplicate(#GldFlag_F5a)	Banadis#a04	722
...
//rachel.gat,124,130,1	duplicate(#GldFlag_F5b)	Banadis#b01	722

//============================================================
// Mysterious Sunflower（アジトダンジョン）
//------------------------------------------------------------
arug_cas05.gat,312,154,3	script	Mysterious Sunflower#F5	977,{
