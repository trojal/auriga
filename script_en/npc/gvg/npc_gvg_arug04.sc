...
// 守備担当
//------------------------------------------------------------
arug_cas04.gat,146,315,3	script	Nios#F4	868,{
	if('guardian1_x[0] == 0) {
...
OnSet:
OnTimer300000:
	hideoffnpc "1st Guardian Stone#F4";
	misceffect 247,"1st Guardian Stone#F4";
	set 'status,2;
	stopnpctimer;
	end;
OnAgitEnd:
...
arug_cas04.gat,65,171,0	script	1st Guardian Stone#F4	844,{
...
OnSet:
OnTimer300000:
	hideoffnpc "Second Guardian Stone#F4";
	misceffect 247,"Second Guardian Stone#F4";
	set 'status,2;
	stopnpctimer;
	end;
OnAgitEnd:
...
arug_cas04.gat,212,149,0	script	Second Guardian Stone#F4	844,{
...
arug_cas04.gat,136,158,0	script	Control Unit01#F4	111,{
...
OnAgitStart:
	...
	callguardian "arug_cas04.gat",140,157," ",1905,1,"Control Unit01#F4::OnKilled";
	callguardian "arug_cas04.gat",142,157," ",1905,1,"Control Unit01#F4::OnKilled";
	callguardian "arug_cas04.gat",144,157," ",1905,1,"Control Unit01#F4::OnKilled";
	callguardian "arug_cas04.gat",139,156," ",1905,1,"Control Unit01#F4::OnKilled";
	callguardian "arug_cas04.gat",141,156," ",1905,1,"Control Unit01#F4::OnKilled";
	callguardian "arug_cas04.gat",143,156," ",1905,1,"Control Unit01#F4::OnKilled";
	set 'count,6;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas04.gat","Control Unit01#F4::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas04.gat",139,158,144,158,0;
...
arug_cas04.gat,135,212,0	script	Control Unit02#F4	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "arug_cas04.gat",140,209," ",1905,1,"Control Unit02#F4::OnKilled";
	callguardian "arug_cas04.gat",142,209," ",1905,1,"Control Unit02#F4::OnKilled";
	callguardian "arug_cas04.gat",144,209," ",1905,1,"Control Unit02#F4::OnKilled";
	callguardian "arug_cas04.gat",139,208," ",1905,1,"Control Unit02#F4::OnKilled";
	callguardian "arug_cas04.gat",141,208," ",1905,1,"Control Unit02#F4::OnKilled";
	callguardian "arug_cas04.gat",143,208," ",1905,1,"Control Unit02#F4::OnKilled";
	set 'count,6;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas04.gat","Control Unit02#F4::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas04.gat",138,210,145,210,0;
...
arug_cas04.gat,134,266,0	script	Control Unit03#F4	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "arug_cas04.gat",139,262," ",1905,1,"Control Unit03#F4::OnKilled";
	callguardian "arug_cas04.gat",141,262," ",1905,1,"Control Unit03#F4::OnKilled";
	callguardian "arug_cas04.gat",143,262," ",1905,1,"Control Unit03#F4::OnKilled";
	callguardian "arug_cas04.gat",145,262," ",1905,1,"Control Unit03#F4::OnKilled";
	set 'count,4;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas04.gat","Control Unit03#F4::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas04.gat",138,263,145,263,0;
...
arug_cas04.gat,45,158,0		duplicate(#LinkFlag_F4)	Gefn#A01	111
arug_cas04.gat,226,156,0	duplicate(#LinkFlag_F4)	Gefn#A02	111
arug_cas04.gat,134,62,0		duplicate(#LinkFlag_F4)	Gefn#A03	111
arug_cas04.gat,149,62,0		duplicate(#LinkFlag_F4)	Gefn#A04	111
arug_cas04.gat,123,154,0	duplicate(#LinkFlag_F4)	Gefn#A05	111
arug_cas04.gat,160,154,0	duplicate(#LinkFlag_F4)	Gefn#A06	111
arug_cas04.gat,135,205,0	duplicate(#LinkFlag_F4)	Gefn#A07	111
arug_cas04.gat,148,205,0	duplicate(#LinkFlag_F4)	Gefn#A08	111
arug_cas04.gat,134,260,0	duplicate(#LinkFlag_F4)	Gefn#A09	111
arug_cas04.gat,149,260,0	duplicate(#LinkFlag_F4)	Gefn#A10	111
arug_cas04.gat,148,103,4	duplicate(#LinkFlag_F4)	Gefn#B11	722
arug_cas04.gat,135,103,4	duplicate(#LinkFlag_F4)	Gefn#B12	722
arug_cas04.gat,63,51,7		duplicate(#LinkFlag_F4)	Gefn#B13	722
arug_cas04.gat,214,51,1		duplicate(#LinkFlag_F4)	Gefn#B14	722

//============================================================
// Kafra Staff
//------------------------------------------------------------
arug_cas04.gat,315,98,5	script	Kafra Staff::AgitKafra_F4	117,{
...
// 執事
//------------------------------------------------------------
arug_cas04.gat,328,98,3	script	Butler	55,{
...
aru_gld.gat,306,359,6	duplicate(#GldFlag_F4a)	Gefn#a01	722
aru_gld.gat,306,348,6	duplicate(#GldFlag_F4a)	Gefn#a02	722
aru_gld.gat,301,318,4	duplicate(#GldFlag_F4a)	Gefn#a03	722
aru_gld.gat,313,318,4	duplicate(#GldFlag_F4a)	Gefn#a04	722
...
//rachel.gat,135,131,7	duplicate(#GldFlag_F4b)	Gefn#b01	722

//============================================================
// Mysterious Sunflower（アジトダンジョン）
//------------------------------------------------------------
arug_cas04.gat,312,154,3	script	Mysterious Sunflower#F4	977,{
