...
// 守備担当
//------------------------------------------------------------
schg_cas03.gat,287,226,5	script	Elzee#N3	868,{
	if('guardiaN3_x[0] == 0) {
...
OnSet:
OnTimer300000:
	hideoffnpc "1st Guardian Stone#N3";
	misceffect 247,"1st Guardian Stone#N3";
	set 'status,2;
	stopnpctimer;
	end;
OnAgitEnd:
...
schg_cas03.gat,242,309,0	script	1st Guardian Stone#N3	844,{
...
OnSet:
OnTimer300000:
	hideoffnpc "Second Guardian Stone#N3";
	misceffect 247,"Second Guardian Stone#N3";
	set 'status,2;
	stopnpctimer;
	end;
OnAgitEnd:
...
schg_cas03.gat,376,250,0	script	Second Guardian Stone#N3	844,{
...
schg_cas03.gat,335,298,0	script	Control Unit01#N3	111,{
...
OnAgitStart:
	...
	callguardian "schg_cas03.gat",326,278," ",1905,1,"Control Unit01#N3::OnKilled";
	callguardian "schg_cas03.gat",328,278," ",1905,1,"Control Unit01#N3::OnKilled";
	callguardian "schg_cas03.gat",330,278," ",1905,1,"Control Unit01#N3::OnKilled";
	callguardian "schg_cas03.gat",327,279," ",1905,1,"Control Unit01#N3::OnKilled";
	callguardian "schg_cas03.gat",329,279," ",1905,1,"Control Unit01#N3::OnKilled";
	callguardian "schg_cas03.gat",331,279," ",1905,1,"Control Unit01#N3::OnKilled";
	set 'count,6;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "schg_cas03.gat","Control Unit01#N3::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "schg_cas03.gat",325,277,332,277,0;
...
schg_cas03.gat,200,227,0	script	Control Unit02#N3	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "schg_cas03.gat",201,231," ",1905,1,"Control Unit02#N3::OnKilled";
	callguardian "schg_cas03.gat",201,233," ",1905,1,"Control Unit02#N3::OnKilled";
	callguardian "schg_cas03.gat",201,235," ",1905,1,"Control Unit02#N3::OnKilled";
	callguardian "schg_cas03.gat",202,232," ",1905,1,"Control Unit02#N3::OnKilled";
	callguardian "schg_cas03.gat",202,234," ",1905,1,"Control Unit02#N3::OnKilled";
	callguardian "schg_cas03.gat",202,236," ",1905,1,"Control Unit02#N3::OnKilled";
	set 'count,6;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "schg_cas03.gat","Control Unit02#N3::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "schg_cas03.gat",200,230,200,237,0;
...
schg_cas03.gat,273,205,0	script	Control Unit03#N3	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "schg_cas03.gat",284,199," ",1905,1,"Control Unit03#N3::OnKilled";
	callguardian "schg_cas03.gat",284,201," ",1905,1,"Control Unit03#N3::OnKilled";
	callguardian "schg_cas03.gat",284,203," ",1905,1,"Control Unit03#N3::OnKilled";
	callguardian "schg_cas03.gat",284,205," ",1905,1,"Control Unit03#N3::OnKilled";
	set 'count,4;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "schg_cas03.gat","Control Unit03#N3::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "schg_cas03.gat",285,198,285,205,0;
...
schg_cas03.gat,301,209,0	script	LF-08#N3	111,{
	setarray '@code,121,122,102;	//"Area 2-1","Area 2-2","中央2区画"
...
schg_cas03.gat,301,194,0	script	LF-09#N3	111,{
	setarray '@code,131,132,103;	//"Area 3-1","Area 3-2","中央3区画"
...
schg_cas03.gat,335,305,0	duplicate(#LinkFlag_N3)	Vidblainn#A01	111
schg_cas03.gat,322,305,0	duplicate(#LinkFlag_N3)	Vidblainn#A02	111
schg_cas03.gat,352,248,0	duplicate(#LinkFlag_N3)	Vidblainn#A03	111
schg_cas03.gat,320,283,0	duplicate(#LinkFlag_N3)	Vidblainn#A04	111
schg_cas03.gat,337,283,0	duplicate(#LinkFlag_N3)	Vidblainn#A05	111
schg_cas03.gat,233,320,0	duplicate(#LinkFlag_N3)	Vidblainn#A06	111
schg_cas03.gat,207,239,0	duplicate(#LinkFlag_N3)	Vidblainn#A07	111
schg_cas03.gat,207,228,0	duplicate(#LinkFlag_N3)	Vidblainn#A08	111
schg_cas03.gat,266,206,0	duplicate(#LinkFlag_N3)	Vidblainn#A09	111
schg_cas03.gat,266,197,0	duplicate(#LinkFlag_N3)	Vidblainn#A10	111
schg_cas03.gat,283,206,2	duplicate(#LinkFlag_N3)	Vidblainn#B11	722
schg_cas03.gat,283,197,2	duplicate(#LinkFlag_N3)	Vidblainn#B12	722
schg_cas03.gat,332,323,6	duplicate(#LinkFlag_N3)	Vidblainn#B13	722
schg_cas03.gat,343,323,2	duplicate(#LinkFlag_N3)	Vidblainn#B14	722

//============================================================
// Kafra Staff
//------------------------------------------------------------
schg_cas03.gat,50,50,3	script	Kafra Staff::AgitKafra_N3	117,{
...
// 執事
//------------------------------------------------------------
schg_cas03.gat,88,90,3	script	Butler	55,{
...
sch_gld.gat,91,191,0	duplicate(#GldFlag_N3a)	Vidblainn#a01	722
sch_gld.gat,104,191,0	duplicate(#GldFlag_N3a)	Vidblainn#a02	722
...
//yuno.gat,111,175,5	duplicate(#GldFlag_N3b)	Vidblainn#b01	722

//============================================================
// Mysterious Sunflower（アジトダンジョン）
//------------------------------------------------------------
schg_cas03.gat,25,22,3	script	Mysterious Sunflower#N3	976,{
