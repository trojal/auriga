...
// 守備担当
//------------------------------------------------------------
arug_cas01.gat,112,193,1	script	Brace#F1	868,{
	if('guardian1_x[0] == 0) {
...
OnSet:
OnTimer300000:
	hideoffnpc "1st Guardian Stone#F1";
	misceffect 247,"1st Guardian Stone#F1";
	set 'status,2;
	stopnpctimer;
	end;
OnAgitEnd:
...
arug_cas01.gat,211,234,0	script	1st Guardian Stone#F1	844,{
...
OnSet:
OnTimer300000:
	hideoffnpc "Second Guardian Stone#F1";
	misceffect 247,"Second Guardian Stone#F1";
	set 'status,2;
	stopnpctimer;
	end;
OnAgitEnd:
...
arug_cas01.gat,308,189,0	script	Second Guardian Stone#F1	844,{
...
arug_cas01.gat,247,52,0	script	Control Unit01#F1	111,{
...
OnAgitStart:
	...
	callguardian "arug_cas01.gat",239,55," ",1905,1,"Control Unit01#F1::OnKilled";
	callguardian "arug_cas01.gat",241,55," ",1905,1,"Control Unit01#F1::OnKilled";
	callguardian "arug_cas01.gat",243,55," ",1905,1,"Control Unit01#F1::OnKilled";
	callguardian "arug_cas01.gat",240,54," ",1905,1,"Control Unit01#F1::OnKilled";
	callguardian "arug_cas01.gat",242,54," ",1905,1,"Control Unit01#F1::OnKilled";
	callguardian "arug_cas01.gat",244,54," ",1905,1,"Control Unit01#F1::OnKilled";
	set 'count,6;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas01.gat","Control Unit01#F1::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas01.gat",239,53,246,53,0;
...
arug_cas01.gat,118,131,0	script	Control Unit02#F1	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "arug_cas01.gat",107,122," ",1905,1,"Control Unit02#F1::OnKilled";
	callguardian "arug_cas01.gat",109,122," ",1905,1,"Control Unit02#F1::OnKilled";
	callguardian "arug_cas01.gat",111,122," ",1905,1,"Control Unit02#F1::OnKilled";
	callguardian "arug_cas01.gat",108,123," ",1905,1,"Control Unit02#F1::OnKilled";
	callguardian "arug_cas01.gat",110,123," ",1905,1,"Control Unit02#F1::OnKilled";
	callguardian "arug_cas01.gat",112,123," ",1905,1,"Control Unit02#F1::OnKilled";
	set 'count,6;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas01.gat","Control Unit02#F1::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas01.gat",107,124,112,124,0;
...
arug_cas01.gat,82,172,0	script	Control Unit03#F1	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "arug_cas01.gat",84,170," ",1905,1,"Control Unit03#F1::OnKilled";
	callguardian "arug_cas01.gat",86,170," ",1905,1,"Control Unit03#F1::OnKilled";
	callguardian "arug_cas01.gat",88,170," ",1905,1,"Control Unit03#F1::OnKilled";
	callguardian "arug_cas01.gat",90,170," ",1905,1,"Control Unit03#F1::OnKilled";
	set 'count,4;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas01.gat","Control Unit03#F1::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas01.gat",84,171,91,171,0;
...
arug_cas01.gat,89,232,0	script	LF-06#F1	111,{
	setarray '@code,33,34;	//"Defense Area 3-3","Defense Area 3-4"
	setarray '@x, 68,105;
	setarray '@y,171,182;
	callfunc "AgitLinkFlagA",'@code,'@x,'@y;
	close;
...
arug_cas01.gat,72,176,0		duplicate(#LinkFlag_F1)	Mardol#A01	111
arug_cas01.gat,103,186,0	duplicate(#LinkFlag_F1)	Mardol#A02	111
arug_cas01.gat,92,126,0		duplicate(#LinkFlag_F1)	Mardol#A03	111
arug_cas01.gat,127,126,0	duplicate(#LinkFlag_F1)	Mardol#A04	111
arug_cas01.gat,150,102,0	duplicate(#LinkFlag_F1)	Mardol#A05	111
arug_cas01.gat,208,68,0		duplicate(#LinkFlag_F1)	Mardol#A06	111
arug_cas01.gat,249,52,0		duplicate(#LinkFlag_F1)	Mardol#A07	111
arug_cas01.gat,234,76,0		duplicate(#LinkFlag_F1)	Mardol#A08	111
arug_cas01.gat,249,76,0		duplicate(#LinkFlag_F1)	Mardol#A09	111
arug_cas01.gat,204,142,0	duplicate(#LinkFlag_F1)	Mardol#A10	111
arug_cas01.gat,183,244,0	duplicate(#LinkFlag_F1)	Mardol#A11	111
arug_cas01.gat,292,219,0	duplicate(#LinkFlag_F1)	Mardol#A12	111
arug_cas01.gat,102,120,4	duplicate(#LinkFlag_F1)	Mardol#B13	722
arug_cas01.gat,117,120,4	duplicate(#LinkFlag_F1)	Mardol#B14	722
arug_cas01.gat,233,140,4	duplicate(#LinkFlag_F1)	Mardol#B15	722

//============================================================
// Kafra Staff
//------------------------------------------------------------
arug_cas01.gat,31,362,3	script	Kafra Staff::AgitKafra_F1	117,{
...
// 執事
//------------------------------------------------------------
arug_cas01.gat,92,380,3	script	Butler	55,{
...
aru_gld.gat,164,270,4	duplicate(#GldFlag_F1a)	Mardol#a01	722
aru_gld.gat,142,235,4	duplicate(#GldFlag_F1a)	Mardol#a02	722
aru_gld.gat,164,245,5	duplicate(#GldFlag_F1a)	Mardol#a03	722
aru_gld.gat,182,255,5	duplicate(#GldFlag_F1a)	Mardol#a04	722
...
//rachel.gat,124,120,3	duplicate(#GldFlag_F1b)	Mardol#b01	722

//============================================================
// Mysterious Sunflower（アジトダンジョン）
//------------------------------------------------------------
arug_cas01.gat,157,345,3	script	Mysterious Sunflower#F1	977,{
