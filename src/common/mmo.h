...
#define MAX_SKILL_DB (MAX_SKILL+MAX_SECONDSKILL+MAX_THIRDSKILL+MAX_QUESTSKILL+MAX_RLSKILL+MAX_KOSKILL+MAX_EX3SKILL+MAX_SUMSKILL+MAX_FOURTHSKILL+MAX_HOMSKILL+MAX_MERCSKILL+MAX_ELEMSKILL+MAX_GUILDSKILL)
