...
#define skill_get_skilldb_id(id) \
	( ((id) >= 0 && (id) < MAX_SKILL) ? (id) : \
	  ...
	  ((id) >= RL_SKILLID && (id) < MAX_RL_SKILLID) ? ((id) - RL_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL) : \
	  ((id) >= KO_SKILLID && (id) < MAX_KO_SKILLID) ? ((id) - KO_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL) : \
	  ((id) >= EX3_SKILLID && (id) < MAX_EX3_SKILLID) ? ((id) - EX3_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_KOSKILL) : \
	  ((id) >= SUM_SKILLID && (id) < MAX_SUM_SKILLID) ? ((id) - SUM_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_KOSKILL + MAX_EX3SKILL) : \
	  ((id) >= FOURTH_SKILLID && (id) < MAX_FOURTH_SKILLID) ? ((id) - FOURTH_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_KOSKILL + MAX_EX3SKILL + MAX_SUMSKILL) : \
	  ((id) >= HOM_SKILLID && (id) < MAX_HOM_SKILLID) ? ((id) - HOM_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_KOSKILL + MAX_EX3SKILL + MAX_SUMSKILL + MAX_FOURTHSKILL) : \
	  ((id) >= MERC_SKILLID && (id) < MAX_MERC_SKILLID) ? ((id) - MERC_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_KOSKILL + MAX_EX3SKILL + MAX_SUMSKILL + MAX_FOURTHSKILL + MAX_HOMSKILL) : \
	  ((id) >= ELEM_SKILLID && (id) < MAX_ELEM_SKILLID) ? ((id) - ELEM_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_KOSKILL + MAX_EX3SKILL + MAX_SUMSKILL + MAX_FOURTHSKILL + MAX_HOMSKILL + MAX_MERCSKILL) : \
	  ((id) >= GUILD_SKILLID && (id) < MAX_GUILD_SKILLID) ? ((id) - GUILD_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_KOSKILL + MAX_EX3SKILL + MAX_SUMSKILL + MAX_FOURTHSKILL + MAX_HOMSKILL + MAX_MERCSKILL + MAX_ELEMSKILL) : \
	  0 )
