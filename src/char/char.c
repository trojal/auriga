...
int max_char_slot = 9;	// �L�����N�^�[�X���b�g�̍ő吔
...
static int mmo_char_send006b(int fd, struct char_session_data *sd)
{
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,32+i*106) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,52+i*106) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,52+i*112) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,133+i*112) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
	}
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,52+i*108) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,130+i*108) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
	}
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,55+i*112) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,137+i*112) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
	}
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,55+i*108) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,133+i*108) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
	}
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,55+i*128) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,137+i*128) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
		memcpy(WFIFOP(fd,139+i*128),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
	}
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,55+i*132) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,137+i*132) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
		memcpy(WFIFOP(fd,139+i*132),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
		WFIFOL(fd,155+i*132) = st->delete_date;	// �폜�ҋ@����
	}
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,55+i*136) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,137+i*136) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
		memcpy(WFIFOP(fd,139+i*136),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
		WFIFOL(fd,155+i*136) = st->delete_date;	// �폜�ҋ@����
		WFIFOL(fd,159+i*136) = st->robe;	// ������
	}
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,55+i*140) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,137+i*140) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
		memcpy(WFIFOP(fd,139+i*140),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
		WFIFOL(fd,155+i*140) = st->delete_date;	// �폜�ҋ@����
		WFIFOL(fd,159+i*140) = st->robe;	// ������
		WFIFOL(fd,163+i*140) = 0;	// TODO: �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
	}
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,55+i*144) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,137+i*144) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
		memcpy(WFIFOP(fd,139+i*144),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
		WFIFOL(fd,155+i*144) = st->delete_date;	// �폜�ҋ@����
		WFIFOL(fd,159+i*144) = st->robe;	// ������
		WFIFOL(fd,163+i*144) = 0;	// TODO: �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,55+i*147) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,139+i*147) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
		memcpy(WFIFOP(fd,141+i*147),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
		WFIFOL(fd,157+i*147) = st->delete_date;	// �폜�ҋ@����
		WFIFOL(fd,161+i*147) = st->robe;	// ������
		WFIFOL(fd,165+i*147) = 0;	// TODO: �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
		WFIFOL(fd,169+i*147) = 0;	// TODO: Add-Ons
		WFIFOB(fd,173+i*147) = st->sex;	// ����
	}
	...
	for( i = 0; i < max_char_slot ; i++ ) {
		...
		WFIFOL(fd,63+i*155) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
		...
		WFIFOW(fd,147+i*155) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
		memcpy(WFIFOP(fd,149+i*155),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
		WFIFOL(fd,165+i*155) = st->delete_date;	// �폜�ҋ@����
		WFIFOL(fd,169+i*155) = st->robe;	// ������
		WFIFOL(fd,173+i*155) = 0;	// TODO: �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
		WFIFOL(fd,177+i*155) = 0;	// TODO: Add-Ons
		WFIFOB(fd,181+i*155) = st->sex;	// ����
	}
...
static void mmo_char_send006d(int fd, const struct mmo_charstatus *st, int sex)
{
	...
	WFIFOW(fd,112) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
	WFIFOSET(fd,114);
#elif PACKETVER < 20100223
	WFIFOW(fd,0) = 0x6d;
	WFIFOL(fd,2) = st->char_id;
	...
	WFIFOB(fd,105) = (st->luk  > 255) ? 255 : st->luk;
	WFIFOW(fd,106) = st->char_num;
	WFIFOW(fd,108) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
	WFIFOSET(fd,110);
#elif PACKETVER < 20100728
	WFIFOW(fd,0) = 0x6d;
	WFIFOL(fd,2) = st->char_id;
	...
	WFIFOW(fd,110) = st->char_num;
	WFIFOW(fd,112) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
	memcpy(WFIFOP(fd,114),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
	WFIFOSET(fd,130);
#elif PACKETVER < 20100803
	WFIFOW(fd,0) = 0x6d;
	WFIFOL(fd,2) = st->char_id;
	...
	WFIFOW(fd,112) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
	memcpy(WFIFOP(fd,114),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
	WFIFOL(fd,130) = st->delete_date;	// �폜�ҋ@����
	WFIFOSET(fd,134);
#elif PACKETVER < 20110928
	WFIFOW(fd,0) = 0x6d;
	WFIFOL(fd,2) = st->char_id;
	...
	WFIFOL(fd,130) = st->delete_date;	// �폜�ҋ@����
	WFIFOL(fd,134) = st->robe;	// ������
	WFIFOL(fd,138) = 0;	// TODO: �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
	WFIFOSET(fd,142);
#elif PACKETVER < 20141022
	WFIFOW(fd,0) = 0x6d;
	WFIFOL(fd,2) = st->char_id;
	...
	WFIFOW(fd,114) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
	memcpy(WFIFOP(fd,116),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
	WFIFOL(fd,132) = st->delete_date;	// �폜�ҋ@����
	WFIFOL(fd,136) = st->robe;	// ������
	WFIFOL(fd,140) = 0;	// TODO: �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
	...
	WFIFOW(fd,122) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
	memcpy(WFIFOP(fd,124),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
	WFIFOL(fd,140) = st->delete_date;	// �폜�ҋ@����
	WFIFOL(fd,144) = st->robe;	// ������
	WFIFOL(fd,148) = 0;	// TODO: �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
							...
							else
							{
...
#if PACKETVER >= 20130320
								{
									...
									for( j = 0; j < max_char_slot ; j++ ) {
										...
										WFIFOL(fdc,32+j*144) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
										...
										WFIFOW(fdc,114+j*144) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
										memcpy(WFIFOP(fdc,116+j*144),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
										if(st->delete_date)
											WFIFOL(fdc,132+j*144) = st->delete_date - (unsigned int)time(NULL);	// �폜�ҋ@����
										else
											WFIFOL(fdc,132+j*144) = 0;
										WFIFOL(fdc,136+j*144) = st->robe;	// ������
										WFIFOL(fdc,140+j*144) = 0;	// �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
									...
									WFIFOW(fdc,2)=found_num*144+4;
										...
										WFIFOL(fdc,32+j*147) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
										...
										WFIFOW(fdc,116+j*147) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
										memcpy(WFIFOP(fdc,118+j*147),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
										if(st->delete_date)
											WFIFOL(fdc,134+j*147) = st->delete_date - (unsigned int)time(NULL);	// �폜�ҋ@����
										else
											WFIFOL(fdc,134+j*147) = 0;
										WFIFOL(fdc,138+j*147) = st->robe;	// ������
										WFIFOL(fdc,142+j*147) = 0;	// �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
										WFIFOL(fdc,146+j*147) = 0;	// TODO: Add-Ons
										WFIFOB(fdc,150+j*147) = st->sex;	// ����
									}
									WFIFOW(fdc,2)=found_num*147+4;
										...
										WFIFOL(fdc,40+j*155) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
										...
										WFIFOW(fdc,124+j*155) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
										memcpy(WFIFOP(fdc,126+j*155),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
										if(st->delete_date)
											WFIFOL(fdc,142+j*155) = st->delete_date - (unsigned int)time(NULL);	// �폜�ҋ@����
										else
											WFIFOL(fdc,142+j*155) = 0;
										WFIFOL(fdc,146+j*155) = st->robe;	// ������
										WFIFOL(fdc,150+j*155) = 0;	// �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
										WFIFOL(fdc,154+j*155) = 0;	// TODO: Add-Ons
										WFIFOB(fdc,158+j*155) = st->sex;	// ����
									}
		...
		case 0x9a1:
			RFIFOSKIP(fd, 2);
			{
				...
				for( j = 0; j < max_char_slot ; j++ ) {
					...
					WFIFOL(fd,32+j*144) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
					...
					WFIFOW(fd,114+j*144) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
					memcpy(WFIFOP(fd,116+j*144),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
					if(st->delete_date)
						WFIFOL(fd,132+j*144) = st->delete_date - (unsigned int)time(NULL);	// �폜�ҋ@����
					else
						WFIFOL(fd,132+j*144) = 0;
					WFIFOL(fd,136+j*144) = st->robe;	// ������
					WFIFOL(fd,140+j*144) = 0;	// �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
				...
				WFIFOW(fd,2)=found_num*144+4;
					...
					WFIFOL(fd,32+j*147) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
					...
					WFIFOW(fd,116+j*147) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
					memcpy(WFIFOP(fd,118+j*147),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
					if(st->delete_date)
						WFIFOL(fd,134+j*147) = st->delete_date - (unsigned int)time(NULL);	// �폜�ҋ@����
					else
						WFIFOL(fd,134+j*147) = 0;
					WFIFOL(fd,138+j*147) = st->robe;	// ������
					WFIFOL(fd,142+j*147) = 0;	// �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
					WFIFOL(fd,146+j*147) = 0;	// TODO: Add-Ons
					WFIFOB(fd,150+j*147) = st->sex;	// ����
				}
				WFIFOW(fd,2)=found_num*147+4;
					...
					WFIFOL(fd,40+j*155) = ( st->option&0x7e80020 ) ? 0 : st->option;	// �R�撆�̃��O�C�����G���[�΍�
					...
					WFIFOW(fd,124+j*155) = 1;	// TODO: �L�������̕ύX���\�ȏ�Ԃ��ǂ���(0��ON 1��OFF)
					memcpy(WFIFOP(fd,126+j*155),st->last_point.map,16);	// �Ō�ɍݐЂ��Ă���MAP��
					if(st->delete_date)
						WFIFOL(fd,142+j*155) = st->delete_date - (unsigned int)time(NULL);	// �폜�ҋ@����
					else
						WFIFOL(fd,142+j*155) = 0;
					WFIFOL(fd,146+j*155) = st->robe;	// ������
					WFIFOL(fd,150+j*155) = 0;	// �X���b�g�ύX���\�ȏ�Ԃ��ǂ���
					WFIFOL(fd,154+j*155) = 0;	// TODO: Add-Ons
					WFIFOB(fd,158+j*155) = st->sex;	// ����
				}
...
int do_init(int argc,char **argv)
{
	...
	printf("Login server IP address (%s)\n", login_host);
	login_ip = host2ip(login_host, "Login server IP address");
	printf("Character server IP address (%s)\n", char_host);
